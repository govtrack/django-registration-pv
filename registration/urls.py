...
urlpatterns = [
    url(r'^ext/(login|associate|verify)/start/(.+)$', registration.views.external_start, name="registration.views.external_start"),
    url(r'^ext/(login|associate|verify)/return/(.+)$', registration.views.external_return),
